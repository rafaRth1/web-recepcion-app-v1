...
import { useGetProductsPaginated } from "../../hooks/use-get-products-paginated";
import { useGetCategoriesForFilter } from "../../hooks/use-get-categories-for-filter";
...
import { PRODUCT_TYPE_LABEL } from "../../constants";
										...
										{selectedProduct && (
											<>
												...
												<p>
													...
													{PRODUCT_TYPE_LABEL[selectedProduct.type] ?? selectedProduct.type}
												</p>
												{/*<p>
